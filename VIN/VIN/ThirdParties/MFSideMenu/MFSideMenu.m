...
- (void)setUpImageBackButton
{
    ...
    UIButton *backButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 73, 34)];
    ...
    self.navigationController.navigationItem.leftBarButtonItem = barBackButtonItem;
...
//        applicationFrame.origin.y = -20;
        self.menuContainerView = [[UIView alloc] initWithFrame:CGRectMake(0,0, SCREEN_WIDTH, SCREEN_HEIGHT)];
...
- (void)setupMenuContainerView {
    ...
    CGRect cFrame  = containerView.frame;
    cFrame.origin.y = 0;
    containerView.frame = cFrame;
